...
class CodexOptimalBot(AuctionBot):
    """Score-differential bidder with category-aware value ceilings."""
    ...
    def choose_bid_round_1(self, state: AuctionState) -> int:
        ...
        opener = min(ceiling, int(self._own_effective_value(state) * 0.78))
